...
class AppTest {
    ...
    @Test
    void testCalcRectangleRoundCorrect1() throws LengthNegativeException, LengthTooLongException {
        RectangleCalc rectangleCalc = new RectangleCalc();
        double a = 1;
        double b = 0.00005;
        double actual = 0;
        ...
        assertEquals(0.0001, actual);
    }

    @Test
    void testCalcRectangleRoundCorrect2() throws LengthNegativeException, LengthTooLongException {
        RectangleCalc rectangleCalc = new RectangleCalc();
        double a = 1;
        double b = 0.00004;
        double actual = 1; // nicht 0 da 0 der erwartete Wert ist
